    ...
    return (
        <div>
            ...
            <div className="bg-purple-100 min-h-screen p-4 font-sans ">
                <div className="max-w-4xl max-lg:max-w-2xl max-sm:max-w-sm mx-auto mb-40">
                        ...
                        <div className="bg-white rounded-2xl p-6">
                            ...
                            <div className="mt-6">
                                ...
                                <div className="mt-6 ">
                                    <button
                                        type="button"
                                        className="flex items-center flex-wrap justify-between gap-2 border rounded-3xl pl-5 pr-3 h-14 w-full hover:bg-purple-100 transition-all duration-300"
                                    >
                                        Explore
